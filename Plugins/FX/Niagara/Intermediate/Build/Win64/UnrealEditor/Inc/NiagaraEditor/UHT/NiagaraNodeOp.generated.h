...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<struct FAddedPinData>();
...
public: \
	DECLARE_CLASS(UNiagaraNodeOp, UNiagaraNodeWithDynamicPins, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), NIAGARAEDITOR_API) \
...
private: \
	...
	UNiagaraNodeOp(const UNiagaraNodeOp&); \
public: \
...
template<> NIAGARAEDITOR_API UClass* StaticClass<class UNiagaraNodeOp>();
