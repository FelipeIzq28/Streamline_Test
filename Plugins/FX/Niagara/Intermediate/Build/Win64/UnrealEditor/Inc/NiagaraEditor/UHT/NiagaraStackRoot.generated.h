...
public: \
	DECLARE_CLASS(UNiagaraStackRoot, UNiagaraStackEntry, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), NIAGARAEDITOR_API) \
...
private: \
	...
	UNiagaraStackRoot(const UNiagaraStackRoot&); \
public: \
