...
public: \
	DECLARE_CLASS(UNiagaraDumpByteCodeCommandlet, UCommandlet, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), NO_API) \
...
private: \
	...
	UNiagaraDumpByteCodeCommandlet(const UNiagaraDumpByteCodeCommandlet&); \
public: \
...
template<> NIAGARAEDITOR_API UClass* StaticClass<class UNiagaraDumpByteCodeCommandlet>();
