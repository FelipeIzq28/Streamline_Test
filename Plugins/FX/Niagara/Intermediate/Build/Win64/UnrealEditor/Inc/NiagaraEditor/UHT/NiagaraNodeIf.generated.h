...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<struct FPinGuidsForPath>();
...
public: \
	DECLARE_CLASS(UNiagaraNodeIf, UNiagaraNodeWithDynamicPins, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), NIAGARAEDITOR_API) \
...
private: \
	...
	UNiagaraNodeIf(const UNiagaraNodeIf&); \
public: \
...
template<> NIAGARAEDITOR_API UClass* StaticClass<class UNiagaraNodeIf>();
