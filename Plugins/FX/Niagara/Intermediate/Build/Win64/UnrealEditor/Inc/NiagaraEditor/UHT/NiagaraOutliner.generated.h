...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<struct FNiagaraOutlinerFilterSettings>();
...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<struct FNiagaraOutlinerViewSettings>();
...
public: \
	DECLARE_CLASS(UNiagaraOutliner, UObject, COMPILED_IN_FLAGS(0 | CLASS_DefaultConfig), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), NO_API) \
...
private: \
	...
	UNiagaraOutliner(const UNiagaraOutliner&); \
public: \
...
template<> NIAGARAEDITOR_API UClass* StaticClass<class UNiagaraOutliner>();
