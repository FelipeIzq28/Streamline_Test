...
public: \
	DECLARE_CLASS(UNiagaraStackObject, UNiagaraStackItemContent, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), NIAGARAEDITOR_API) \
...
private: \
	...
	UNiagaraStackObject(const UNiagaraStackObject&); \
public: \
...
template<> NIAGARAEDITOR_API UClass* StaticClass<class UNiagaraStackObject>();
