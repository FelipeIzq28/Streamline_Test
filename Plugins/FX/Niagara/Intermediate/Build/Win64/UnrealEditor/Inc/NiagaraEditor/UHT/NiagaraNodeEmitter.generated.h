...
public: \
	DECLARE_CLASS(UNiagaraNodeEmitter, UNiagaraNodeWithDynamicPins, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), NIAGARAEDITOR_API) \
...
private: \
	...
	UNiagaraNodeEmitter(const UNiagaraNodeEmitter&); \
public: \
...
template<> NIAGARAEDITOR_API UClass* StaticClass<class UNiagaraNodeEmitter>();
